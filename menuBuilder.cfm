...
<cfoutput query="thisMenuR"><cfset linktitle=Replace(Replace(Replace(linkname,"mailing [list]","sign up for mailing list","all"),"[","","all"),"]","","all")><div id="iconR#menuRRnum#"><cfif Find("http",linkurl) EQ 0 AND Find(".cfm",linkurl) EQ 0><cfset linktitle=Replace(Replace(Replace(linkurl,"mailto:","","all"),"sms:","","all"),"tel:","","all")><a id="menuR#menuRRnum#" onclick="open_nonurl_and_reload('#linkurl#')" href="##" title="#linktitle#"><cfelseif target NEQ ""><a id="menuR#menuRRnum#" onclick="open_in_new_tab_and_reload('#linkurl#',#Find(linkurl,"http")#)" href="##" title="#linktitle#"><cfelse><a id="menuR#menuRRnum#" href="#linkurl#" title="#linktitle#"></cfif><img alt="#linktitle#" src="images/spacer.gif" width="78" height="78" border="0" title="#linktitle#" /></a></div><cfif menuR EQ 4 AND menuRRnum EQ url.rr><cfset thisPage=Replace(linkname," ","","all")></cfif>
</cfoutput>
